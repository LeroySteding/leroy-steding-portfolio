...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative py-24 bg-cyber-black overflow-hidden">
                ...
                >
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <Link href={`/experience/${exp.id}`}>
                      <div className={`ml-16 md:ml-0 p-6 rounded-xl bg-cyber-darker border border-cyber-gray-light glass hover:border-neon-${exp.color}/50 transition-all duration-300 group hover:scale-105 cursor-pointer`}>
                        ...
                        <h3 className="text-2xl font-display font-bold mb-1 text-text-primary group-hover:text-neon-cyan transition-colors">
                          {exp.title}
                        </h3>
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <h4 className={`text-lg font-semibold text-neon-${exp.color}`}>
                            {exp.company}
                          </h4>
                        </div>
