...
// ============================================================================
export var findTaskByLinearId = internalQuery({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db
                        .query("agent_tasks")
                        .withIndex("by_linear_issue", function (q) {
                        return q.eq("linearIssueId", args.linearIssueId);
                    })
                        .first()];
...
export var getTask = internalQuery({
...
export var createTaskFromLinear = internalMutation({
    args: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.insert("agent_tasks", {
                        ...
                        context: "Linear: ".concat(args.linearUrl),
                        dependencies: [],
...
export var updateTaskFromLinear = internalMutation({
    args: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ctx.db.patch(taskId, __assign(__assign({}, updates), { updatedAt: Date.now() }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export var updateTaskLinearId = internalMutation({
    args: {
        taskId: v.id("agent_tasks"),
        linearIssueId: v.string(),
    },
