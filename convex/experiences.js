        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    experiences = _a.sent();
                    if (args.locale) {
                        experiences = experiences.filter(function (exp) { return exp.locale === args.locale; });
                    }
                    if (args.type) {
                        experiences = experiences.filter(function (exp) { return exp.type === args.type; });
                    }
...
export var push = mutation({
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.query("experiences")
                        .withIndex("by_company", function (q) { return q.eq("company", args.company); })
                        .collect()];
                case 1:
                    existing = _a.sent();
                    match = existing.find(function (i) { return i.title === args.title; });
                    if (!match) return [3 /*break*/, 3];
                    return [4 /*yield*/, ctx.db.patch(match._id, args)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, match._id];
                case 3: return [4 /*yield*/, ctx.db.insert("experiences", args)];
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, ctx.db.insert("experiences", args)];
                case 2:
                    experienceId = _a.sent();
                    return [2 /*return*/, experienceId];
            }
        });
    }); },
});
...
export var update = mutation({
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        var id, updates, existingExperience;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, requireAuth(ctx)];
                case 1:
