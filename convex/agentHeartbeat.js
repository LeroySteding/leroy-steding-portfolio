 ...
 */
export var registerHeartbeat = mutation({
    args: {
        agentName: v.string(),
        sessionId: v.string(),
 ...
 */
export var registerDemoAgents = mutation({
    args: {},
    handler: function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var agents, _loop_1, _i, agents_1, agent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    agents = [
                    ...
                    _loop_1 = function (agent) {
                        var sessionId, existing;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    sessionId = "demo-".concat(agent.name, "-").concat(Date.now());
                                    return [4 /*yield*/, ctx.db
                                            .query("agent_sessions")
                                            .filter(function (q) { return q.eq(q.field("agentName"), agent.name); })
                                            .first()];
                                case 1:
                                    existing = _b.sent();
                                    if (!existing) return [3 /*break*/, 3];
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, { registered: agents.length }];
            }
        });
    }); },
});
