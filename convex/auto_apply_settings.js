...
export const mode = v.union(v.literal("manual"), // Review each job, one-click apply
...
export const getStats = query({
    ...
    handler: async (ctx) => {
        ...
        const todayApplications = allApplications.filter(app => app.appliedAt && app.appliedAt >= todayMs);
        const autoApplications = allApplications.filter(app => app.appliedVia === "auto-apply");
        return {
