...
export const governmentInsights = query({
  ...
  handler: async (ctx) => {
    ...
    active.forEach((job) => {
      ...
      if (desc.includes("gemeente") || desc.includes("municipal")) sectors.set("Municipal", (sectors.get("Municipal") || 0) + 1);
      if (desc.includes("provincie") || desc.includes("provincial")) sectors.set("Provincial", (sectors.get("Provincial") || 0) + 1);
      if (desc.includes("ministerie") || desc.includes("ministry")) sectors.set("Ministry", (sectors.get("Ministry") || 0) + 1);
      if (desc.includes("waterschappen") || desc.includes("water board")) sectors.set("Water Board", (sectors.get("Water Board") || 0) + 1);
      if (desc.includes("zorg") || desc.includes("healthcare")) sectors.set("Healthcare", (sectors.get("Healthcare") || 0) + 1);
      if (desc.includes("onderwijs") || desc.includes("education")) sectors.set("Education", (sectors.get("Education") || 0) + 1);
