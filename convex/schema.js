...
export default defineSchema({
    ...
    job_applications: defineTable({
        ...
        appliedVia: v.optional(v.union(v.literal("manual"), v.literal("auto-apply"), v.literal("one-click"))),
        matchScore: v.optional(v.number()), // 0-100 match score
        applicationMode: v.optional(v.union(v.literal("manual"), v.literal("semi-auto"), v.literal("full-auto"))),
    ...
    job_preferences: defineTable({
        ...
        remotePreference: v.union(v.literal("required"), v.literal("preferred"), v.literal("acceptable"), v.literal("no_preference")),
        // Salary preferences
        minSalary: v.optional(v.number()),
        maxSalary: v.optional(v.number()),
        salaryCurrency: v.optional(v.string()), // "EUR", "USD"
        // Tech stack (skill names with proficiency weights)
        techStackPreferences: v.array(v.object({
    ...
    job_matches: defineTable({
        ...
        actionTaken: v.optional(v.union(v.literal("applied"), v.literal("saved"), v.literal("dismissed"), v.literal("no_action"))),
        createdAt: v.number(),
    })
    ...
    auto_apply_settings: defineTable({
        mode: v.union(v.literal("manual"), // Review each job, one-click apply
    ...
    workflows: defineTable({
        ...
        status: v.union(v.literal("pending"), v.literal("running"), v.literal("paused"), v.literal("completed"), v.literal("failed"), v.literal("cancelled")),
        priority: v.union(v.literal("low"), v.literal("medium"), v.literal("high"), v.literal("critical")),
    ...
    workflow_steps: defineTable({
        ...
        status: v.union(v.literal("pending"), v.literal("running"), v.literal("completed"), v.literal("failed"), v.literal("skipped"), v.literal("blocked")),
        // Dependencies
    ...
    workflow_templates: defineTable({
        ...
        defaultPriority: v.union(v.literal("low"), v.literal("medium"), v.literal("high"), v.literal("critical")),
    ...
    workflow_executions: defineTable({
        ...
        stepId: v.string(),
        agent: v.string(),
        action: v.union(v.literal("started"), v.literal("completed"), v.literal("failed"), v.literal("retried"), v.literal("skipped")),
