    ...
    <div className="min-h-screen bg-gradient-to-br from-cyber-black via-cyber-darker to-cyber-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          ...
          <header className="mb-10 pb-8 border-b-2 border-gray-200 relative">
            ...
            <div className="pr-36">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-gray-700">
                <div className="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">📧 {data.personalInfo.email}</div>
                <div className="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">📍 {data.personalInfo.location}</div>
                <div className="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">💼 {data.personalInfo.linkedin}</div>
                <div className="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">🔗 {data.personalInfo.website}</div>
                <div className="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">💻 {data.personalInfo.github}</div>
              </div>
            </div>
          </header>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed text-base pl-4" style={{ lineHeight: '1.7' }}>
            {data.summary}
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          {data.experience.map((exp, index) => (
            <div key={index}>
              ...
              <p className="text-gray-700 mb-3 text-sm" style={{ lineHeight: '1.7' }}>
                {exp.description}
              </p>
        ...
        <section className="mb-10">
          ...
          {data.education.map((edu, index) => (
            <div key={index}>
              ...
              {edu.description && (
                <p className="text-sm text-gray-600 mt-2" style={{ lineHeight: '1.6' }}>{edu.description}</p>
              )}
            </div>
          ))}
          </div>
