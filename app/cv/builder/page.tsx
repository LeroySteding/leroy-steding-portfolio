          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
              ...
              >
                ...
                {!atsMode && <div className="h-0.5 w-full bg-gradient-to-r from-cyan-500 via-violet-500 to-blue-500 mb-10" />}
                ...
                <section className="mb-12">
                  <h3 className="text-2xl font-bold mb-5 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <Sparkles className="w-6 h-6 text-violet-600 dark:text-violet-400" />}
                      {t.summary}
                    </span>
                  </h3>
                  <EditableField
                ...
                <section className="mb-12">
                  <h3 className="text-2xl font-bold mb-5 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <Briefcase className="w-6 h-6 text-cyan-600 dark:text-cyan-400" />}
                      {t.experience}
                    </span>
                  </h3>
                  {data.experience.map((exp, index) => (
                    <div key={index} className="mb-8 last:mb-0">
                      ...
                      {exp.technologies && exp.technologies.length > 0 && (
                        <div className="mt-3">
                          <p className={atsMode ? "text-xs font-semibold mb-2" : "text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2"}>
                            {t.technologies}:
                          </p>
                ...
                <section className="mb-12">
                  <h3 className="text-2xl font-bold mb-5 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <FolderGit2 className="w-6 h-6 text-violet-600 dark:text-violet-400" />}
                      {t.projects}
                    </span>
                  </h3>
                ...
                <section className="mb-12">
                  <h3 className="text-2xl font-bold mb-5 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <GraduationCap className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                      {t.education}
                    </span>
                  </h3>
                ...
                <section className="mb-12">
                  <h3 className="text-2xl font-bold mb-5 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <Award className="w-6 h-6 text-amber-600 dark:text-amber-400" />}
                      {t.certifications}
                    </span>
                  </h3>
                      ...
                      <div key={index} className="flex justify-between items-start">
                        <div className="flex-1">
                          <EditableField
                            ...
                            value={cert.name}
                            className={atsMode ? "text-sm font-semibold" : "text-sm font-semibold text-gray-900 dark:text-white"}
                          />
                          <EditableField
                            path={`certifications[${index}].issuer`}
                            value={cert.issuer}
                            className={atsMode ? "text-xs" : "text-xs text-gray-600 dark:text-gray-400"}
                          />
                        </div>
                        <EditableField
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white pb-3 border-b-2 border-gray-200 dark:border-gray-700">
                    <span className="inline-flex items-center gap-2">
                      {!atsMode && <Languages className="w-6 h-6 text-green-600 dark:text-green-400" />}
                      {t.languages}
                    </span>
                  </h3>
                  <div className="flex flex-wrap gap-4">
                    {data.languages.map((lang, index) => (
                      ...
                      >
                        {!atsMode && <Globe className="w-4 h-4 text-green-600 dark:text-green-400" />}
                        <div>
                          <EditableField
