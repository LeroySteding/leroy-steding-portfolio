...
export const nl: Translations = {
  ...
  projects: {
    ...
    detail: {
      ...
      challenges: "Belangrijkste Uitdagingen",
      theSolution: "De Oplossing",
      solutions: "Geïmplementeerde Oplossingen",
      theResults: "De Resultaten",
      impact: "Impact & Resultaten",
      ...
      duration: "Duur",
      client: "Klant",
      deliverables: "Belangrijkste Opleverpunten",
      cta: {
