...
import { Mail, MapPin, Phone, Linkedin, Github, Twitter, Send, Calendar, Download, ExternalLink, ChevronDown, CheckCircle2, X } from "lucide-react";
              ...
              <div className="card p-8 md:p-10">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8 p-5 rounded-xl bg-surface">
                  <div className="text-center">
                    <div className="text-2xl md:text-3xl font-bold text-accent-primary">24h</div>
                    <div className="text-xs text-text-muted">{t.contact.form.trustIndicators.responseTime}</div>
                  </div>
                  <div className="text-center">
                    ...
                    <div className="text-xs text-text-muted">{t.contact.form.trustIndicators.availableNow}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl md:text-3xl">🔒</div>
                    <div className="text-xs text-text-muted">{t.contact.form.trustIndicators.securePrivate}</div>
                  </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                  {submitStatus === "success" ? (
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-text-secondary mb-1">
                            {t.contact.form.successMessage.body} <strong className="text-text-primary">{formData.email}</strong> {t.contact.form.successMessage.bodyEnd}
                          </p>
                    ...
                    >
                      ...
                      <div>
                        <label htmlFor="email" className="block text-base font-bold mb-2 text-text-primary">
                      ...
                      <div>
                        <label htmlFor="message" className="block text-base font-bold mb-2 text-text-primary">
                          How can I help?
                        </label>
                        <textarea
                          id="message"
                        ...
                        <div className="flex justify-between items-center text-sm mt-2">
                          <span className={
                            messageLength === 0 ? "text-text-muted" :
                            isMessageTooShort ? "text-orange-500" :
                            isMessageGoodLength ? "text-green-500" :
                            "text-text-muted"
                          }>
                            {messageLength === 0 ? t.contact.form.messagePlaceholder :
                             isMessageTooShort ? t.contact.form.validation.tooShort :
                      ...
                      <div>
                        ...
                        >
                          ...
                          {showOptionalFields ? t.contact.form.actions.hideOptional : t.contact.form.actions.showOptional} {t.contact.form.actions.optionalLabel}
                        </button>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-text-secondary">
                                ...
                                <a href="mailto:leroy@steding.digital" className="underline hover:no-underline">
