...
import { 
  ArrowLeft, Check, Calendar, Code, Sparkles, Zap, Rocket, Globe, Database,
  TrendingUp, Clock, Target, Activity, Shield, Award, Briefcase, Heart,
  GraduationCap, Layers, Package, GitBranch, FileCode, Smartphone, Search
} from "lucide-react";
...
const iconMap = {
  Code, Sparkles, Zap, Rocket, Globe, Database, TrendingUp, Clock, Target,
  Activity, Shield, Award, Briefcase, Heart, GraduationCap, Layers, Package,
  GitBranch, FileCode, Smartphone, Search
};
...
export default function ServiceDetailClient({ service }: ServiceDetailClientProps) {
  ...
  return (
    <main className="min-h-screen bg-primary-bg">
        ...
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          ...
          >
            ...
            >
              ...
              <span className="font-medium">Terug naar Diensten</span>
            </Link>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {(t.services as any)[service.titleKey]?.description || service.descriptionKey}
            </motion.p>
            ...
            >
              <Link href="/nl/book" className="btn-primary inline-flex items-center gap-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {service.stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.gradient} flex items-center justify-center mx-auto mb-4`}>
      ...
      <section className="section relative bg-secondary-bg">
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          <div className="max-w-6xl mx-auto">
            ...
            >
              Wat is <span className="text-gradient">Inbegrepen</span>
            </motion.h2>
      ...
      {/* Process, Technologies, Benefits sections similar to English version... */}
        ...
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          ...
          >
            <h2 className="font-display font-black text-4xl md:text-5xl mb-6">
              Klaar om Uw Bedrijf te <span className="text-gradient">Transformeren?</span>
            </h2>
            <p className="text-xl text-text-secondary mb-10 leading-relaxed">
              Laten we bespreken hoe {((t.services as any)[service.titleKey]?.title || service.titleKey).toLowerCase()} u kan helpen uw doelen te bereiken
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/nl/book" className="btn-primary inline-flex items-center justify-center gap-3">
                <Calendar className="w-5 h-5" />
                Plan Gratis Consultatie
              </Link>
              <Link href="/nl/contact" className="btn-secondary inline-flex items-center justify-center gap-3">
                Neem Contact Op
              </Link>
            </div>
          </motion.div>
