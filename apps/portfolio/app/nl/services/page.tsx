      ...
      <section className="section relative bg-gradient-to-b from-primary-bg to-secondary-bg overflow-hidden pt-32">
        ...
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            >
              Professionele <span className="text-gradient">Diensten</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Uitgebreide oplossingen om uw bedrijf te transformeren met moderne technologie en AI automatisering
            </motion.p>
          </div>
        </div>
      </section>
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card */}
                  <Link href={`/nl/services/${service.slug}`}>
        ...
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          ...
          >
            <h2 className="font-display font-black text-4xl md:text-5xl mb-6">
              Klaar om te <span className="text-gradient">Beginnen?</span>
            </h2>
            <p className="text-xl text-text-secondary mb-10 leading-relaxed">
              Laten we uw project bespreken en de perfecte oplossing voor uw behoeften vinden
            </p>
