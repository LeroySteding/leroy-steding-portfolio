...
export const metadata: Metadata = {
  title:
    "Book a Free Consultation | Full-Stack Developer & AI Automation Architect",
  description:
    "Schedule a free consultation with Leroy Steding - Expert in Next.js, React, AI Automation, and SaaS Architecture. Get technical advice, architecture reviews, and project planning. Available for 15-min quick chats, 30-min consultations, or 60-min deep dives.",
  keywords: [
  ...
  twitter: {
    ...
    description:
      "Expert technical consultation for web development, AI automation, and SaaS architecture.",
...
const structuredData = {
  ...
  description:
    "Professional technical consultation for web development, AI automation, and SaaS architecture",
  provider: {
    "@type": "Person",
    name: "Leroy Steding",
  ...
  offers: [
    {
      ...
      priceCurrency: "EUR",
      description:
        "15-minute quick consultation for brief questions or introductions",
    },
    {
      "@type": "Offer",
      ...
      priceCurrency: "EUR",
      description:
        "30-minute consultation to discuss project requirements in detail",
    },
    {
      "@type": "Offer",
      ...
      priceCurrency: "EUR",
      description:
        "60-minute in-depth technical planning and architecture review",
    },
  ],
};
