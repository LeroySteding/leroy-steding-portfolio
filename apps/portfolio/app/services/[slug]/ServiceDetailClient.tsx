          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              {service.processSteps.map((step, index) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.gradient} flex items-center justify-center flex-shrink-0 font-bold text-white text-xl`}>
                    {index + 1}
                  </div>
        ...
        <div className="container relative z-10 mx-auto px-8 lg:px-16">
          ...
          >
            ...
            <p className="text-xl text-text-secondary mb-10 leading-relaxed">
              Let's discuss how {((t.services as any)[service.titleKey]?.title || service.titleKey).toLowerCase()} can help you achieve your goals
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="btn-secondary inline-flex items-center justify-center gap-3">
                Contact Us
              </Link>
            </div>
          </motion.div>
