...
async function createDefaultSections() {
  ...
  const sections = [
    ...
    // About Sections
    {
      ...
      language: 'en',
      titleHighlight: 'Me',
      description: 'Passionate developer with expertise in building scalable applications',
    ...
    },
    {
      ...
      language: 'nl',
      titleHighlight: 'Mij',
      description: 'Gepassioneerde ontwikkelaar met expertise in schaalbare applicaties',
      content: '## Mijn Verhaal\n\nIk ben een full-stack developer gespecialiseerd in moderne webtechnologieën...',
    },
    ...
    },
    {
      ...
      language: 'nl',
      titleHighlight: 'Stack',
      description: 'Technologieën die ik gebruik om geweldige producten te bouwen',
      categories: [
        {
          name: 'Frontend',
          icon: 'frontend',
