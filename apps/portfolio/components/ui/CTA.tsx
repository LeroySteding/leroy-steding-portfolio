...
export default function CTA({
  ...
  const PrimaryIcon = config.primaryButton?.icon
    ? iconMap[config.primaryButton.icon]
    : ArrowRight;
  const SecondaryIcon =
    config.secondaryButton?.icon && config.secondaryButton.icon in iconMap
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {config.primaryButton && (
              <Link
                ...
                target={
                  config.primaryButton.href.startsWith("http")
                    ? "_blank"
                    : undefined
                }
                rel={
            ...
            {config.secondaryButton && (
              <Link
                ...
                target={
                  config.secondaryButton.href.startsWith("http")
                    ? "_blank"
                    : undefined
                }
                rel={
