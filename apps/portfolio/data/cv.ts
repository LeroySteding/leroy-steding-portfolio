...
export const cvData: CVData = {
  ...
  skills: [
    {
      ...
      items: [
        ...
        "Tailwind CSS",
        "SASS/SCSS (Modules, Mixins)",
        "Styled Components",
        "CSS-in-JS",
        "Responsive Design (Mobile-First)",
        "Progressive Web Apps (PWA, Service Workers)",
        "Web Accessibility (WCAG 2.1 AA/AAA, ARIA)",
        "SEO Optimization",
    ...
    },
    {
      ...
      items: [
        ...
        "Git (Advanced Workflows, Rebasing)",
        "GitHub Actions",
        "GitLab CI/CD",
        "Jenkins",
        "CircleCI",
    ...
    },
    {
      ...
      items: [
        "Agile/Scrum (Daily Standups, Sprints)",
        "Kanban",
        "Lean Development",
    ...
    },
    {
      ...
      items: [
        "Technical Leadership (Team Lead, Architect)",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Digital transformation initiative implementing AI automation for manufacturing operations. Built intelligent document processing using OpenAI GPT-4 and automated workflow orchestration with n8n connecting ERP and CRM systems. Created dashboards for production monitoring and quality control.",
      technologies: [
        "OpenAI GPT-4",
        "LangChain",
        "Python",
    ...
    },
    {
      ...
      description:
        "SaaS platform for automated web accessibility testing and WCAG compliance. Built scanning engine using Playwright for cross-browser testing with detailed reporting and remediation recommendations. Developed Chrome extension for real-time accessibility auditing during development.",
      technologies: [
        "Next.js",
        "Playwright",
        "PostgreSQL",
    ...
    },
    {
      ...
      description:
        "Modern commerce platform built on MedusaJS with custom Next.js storefront. Architected multi-currency solution with Stripe payment processing and Algolia product search. Built admin dashboard for inventory and order management with subscription support.",
      technologies: [
        "MedusaJS",
        "Next.js",
        "TypeScript",
  ...
  education: [
    {
      ...
      period: "2014 - 2019",
      description:
        "Focus on software architecture, web technologies, and agile development methodologies",
    },
    {
      ...
      period: "2011 - 2014",
      description:
        "ICT Application Development with focus on web development and database design",
    },
  ],
