...
export const experiencesNL: Experience[] = [
  {
    id: "surf",
...
In nauwe samenwerking met andere teams en stakeholders zorgen we ervoor dat het platform niet alleen schaalbaar en onderhoudbaar is, maar ook voldoet aan moderne normen voor prestaties, WCAG-toegankelijkheid en multi-brand theming.`,
    technologies: [
      "Next.js",
      "Turborepo",
      "TypeScript",
    ...
    color: "cyan",
    highlights: [
      "Gedeelde UI-componentenbibliotheek ontwikkeld voor multi-brand theming",
      "CI/CD-pijplijnen geïmplementeerd voor betrouwbare implementaties over dev/staging/prod",
      "WCAG-toegankelijkheidsnaleving gewaarborgd op alle platforms",
      "Herbruikbare API-clients en state management-oplossingen gebouwd",
    ],
    achievements: [
      "Ontwikkeltijd met 40% verminderd door gedeelde componentenbibliotheek",
      "100% WCAG 2.1 AA-naleving bereikt op alle platforms",
      "Multi-brand platform succesvol gelanceerd dat 50.000+ educatieve bronnen bedient",
    ],
    responsibilities: [
      "Architectuur en ontwikkeling van gedeelde UI-componentenbibliotheken",
      "Implementatie en onderhoud van CI/CD-pijplijnen in GitLab",
      "Samenwerking met ontwerpers aan design system-implementatie",
      "Toegankelijkheidsnaleving en prestatie-optimalisatie garanderen",
      "Junior developers begeleiden in moderne frontend best practices",
    ],
    teamSize: "8-10 ontwikkelaars",
    impact: [
      "Bedient Edusources en MBOdata platforms",
      "Ondersteunt meerdere onderwijsinstellingen",
      "Maakt snelle ontwikkeling van nieuwe applicaties mogelijk",
    ],
  },
  {
    id: "hifive",
    ...
    description:
      "Digitaal innovatiebureau opgericht, gespecialiseerd in custom e-commerceplatforms, mobiele applicaties en websites met AI-technologieën en software-integraties.",
    longDescription: `Bij Hifive geloven we in de kracht van maatwerk oplossingen om bedrijven te transformeren. Onze expertise in het creëren van unieke e-commerce platforms, mobiele applicaties en custom websites, ondersteund door de nieuwste AI-technologieën en software-integraties, stelt ons in staat om uw digitale aanwezigheid te optimaliseren.
...
We zijn trots op ons vermogen om complexe uitdagingen te vertalen naar gebruiksvriendelijke, effectieve oplossingen. Onze aanpak is altijd persoonlijk, met focus op het opbouwen van duurzame relaties met onze klanten. Hifive is meer dan een leverancier; we zijn uw partner in digitale innovatie.`,
    technologies: [
      "Next.js",
      "React Native",
      "AI/ML",
    ...
    color: "violet",
    highlights: [
      "12+ jaar levering van custom digitale oplossingen",
      "AI-aangedreven e-commerce en mobiele platforms",
      "Langdurige klantpartnerschappen en digitale transformatie",
      "Full-service digitaal innovatiebureau",
    ],
    achievements: [
      "Succesvol 100+ custom projecten opgeleverd",
      "Langdurige partnerschappen opgebouwd met 50+ klanten",
      "Pionier in AI-integratie in Nederlandse MKB-markt",
      "95% klantretentie gehandhaafd",
    ],
    responsibilities: [
      "Ontwikkeling van custom e-commerceplatforms leiden",
      "AI-aangedreven bedrijfsoplossingen architecten",
      "Klantrelaties en projectoplevering beheren",
      "Ontwikkelteam opbouwen en begeleiden",
      "Technische innovatie en strategie stimuleren",
    ],
    impact: [
      "Digitale operaties getransformeerd voor 50+ bedrijven",
      "Miljoenen aan extra omzet gegenereerd voor klanten",
      "Schaalbare platforms gecreëerd die duizenden gebruikers bedienen",
    ],
  },
  {
    id: "vodafoneziggo",
    ...
    location: "Utrecht, Nederland",
    description:
      "Ontwikkeling van hoogpresterende cross-platform mobiele applicaties met React Native, Expo en TypeScript. Schaalbaar ontwerpsysteem gebouwd met Storybook.",
...
Ik gebruikte Storybook om een schaalbaar ontwerpsysteem te ontwikkelen en te onderhouden, waardoor efficiënte componenttesting en UI-consistentie mogelijk werd. Het schrijven van robuuste, onderhoudbare code stond centraal, ondersteund door ESLint voor statische analyse en Jest voor unit- en integratietesting.
...
Deze ervaring verdiepte mijn expertise in mobiele ontwikkeling, toegankelijkheid en CI/CD best practices binnen een enterprise omgeving.`,
    technologies: [
      "React Native",
      "Expo",
      "TypeScript",
    ...
    color: "cyan",
    highlights: [
      "Schaalbaar ontwerpsysteem gebouwd met Storybook",
      "WCAG-toegankelijkheidsnaleving overal gewaarborgd",
      "Enterprise CI/CD best practices geïmplementeerd",
      "Hoge codekwaliteit gehandhaafd met SonarQube",
    ],
    achievements: [
      "Mobiele app opgeleverd die 3M+ actieve gebruikers bedient",
      "99,9% uptime en 4,5+ ster app store beoordeling bereikt",
      "Componentontwikkelingstijd met 50% verminderd met ontwerpsysteem",
      "90%+ testdekking gehandhaafd over hele codebase",
    ],
    responsibilities: [
      "Cross-platform mobiele functies ontwikkelen met React Native",
      "Componentenbibliotheek bouwen en onderhouden in Storybook",
      "Toegankelijkheidsnormen implementeren (WCAG 2.1)",
      "Uitgebreide tests schrijven met Jest",
      "Samenwerken met ontwerpers en backend teams",
    ],
    teamSize: "15-20 ontwikkelaars",
    impact: [
      "Miljoenen VodafoneZiggo-klanten bedienen",
      "Naadloos account- en servicebeheer mogelijk maken",
      "Klanttevredenheidsscores verbeteren",
    ],
  },
  {
    id: "bravelink",
    ...
    description:
      "Data-gedreven talent matchmaker die softwareontwikkelingsexpertise combineert met een mensgerichte aanpak.",
    longDescription: `Ik ben een data-gedreven opdracht matchmaker bij BraveLink, met een achtergrond in softwareontwikkeling en een passie voor mensen. Dankzij mijn expertise in technologie en data-analyse creëer ik de ideale match tussen talent en organisaties, ongeacht de sector.

Mijn expertisegebieden omvatten strategische matching gericht op zowel vaardigheden als bedrijfscultuur, data-analyse met gebruik van inzichten voor nauwkeurige plaatsingen, en softwareontwikkeling waarbij ik technologische oplossingen creëer voor effectieve matches. Mijn doel is om mensen en bedrijven samen te brengen voor wederzijds succes.`,
    technologies: [
      "Data-analyse",
    ...
    color: "violet",
    highlights: [
      "Technologie-gedreven talent matchingplatform",
      "Strategische data-analyse voor optimale plaatsingen",
      "Cross-sector expertise en flexibiliteit",
    ],
    achievements: [
      "Succesvol 50+ professionals geplaatst in ideale rollen",
      "95% plaatsingsretentie bereikt na 6 maanden",
      "Data-gedreven matchingalgoritmen gebouwd",
    ],
    responsibilities: [
      "Kandidaatvaardigheden en culturele fit analyseren",
      "Professionals matchen met organisaties",
      "Matchingalgoritmen en tools ontwikkelen",
      "Relaties opbouwen met klanten en kandidaten",
    ],
    impact: [
      "Talent verbonden met toonaangevende organisaties",
      "Plaatsingssuccesspercentages verbeterd",
      "Time-to-hire voor klanten verminderd",
    ],
  },
  {
    id: "braveorange",
    ...
    location: "Amsterdam, Nederland",
    description:
      "Full-stack ontwikkeling met Java, Spring Boot, JavaScript en TypeScript. Uitgebreide webapplicaties gebouwd met moderne frameworks.",
    longDescription: `Bij Brave Orange was ik actief als Fullstack Developer, waarbij ik een breed scala aan technieken inzette, waaronder Java, Spring Boot, JavaScript en TypeScript. Mijn rol omvatte het ontwikkelen en implementeren van uitgebreide webapplicaties.

Ik bracht rijke ervaring mee in het gebruik van geavanceerde technologieën zoals React, Node.js, Next.js en verschillende andere moderne frameworks en tools, wat bijdroeg aan mijn voortdurend groeiende passie voor technische innovatie.`,
    technologies: [
      "React",
      "Next.js",
      "TypeScript",
    ...
    highlights: [
      ...
      "Moderne framework implementatie",
      "Technische innovatie en best practices",
    ],
    achievements: [
      "Meerdere enterprise webapplicaties opgeleverd",
      "Frontend en backend systemen naadloos geïntegreerd",
      "Junior developers begeleid in best practices",
    ],
    responsibilities: [
      "Full-stack webapplicaties ontwikkelen",
      "Moderne React en Next.js oplossingen implementeren",
      "Backend services bouwen met Java en Spring Boot",
      "Samenwerken met cross-functionele teams",
    ],
    teamSize: "10-15 ontwikkelaars",
  },
  {
    id: "robidus",
    ...
    location: "Nederland",
    description:
      "Ontwikkeling van geavanceerd applicatieplatform met integratie van diverse datastromen voor WGA- en Ziektewetbegeleiding.",
    longDescription: `Bij Robidus speelde ik een belangrijke rol in de ontwikkeling van een geavanceerd applicatieplatform gericht op het integreren van verschillende datastromen voor WGA- en Ziektewetbegeleiding. Mijn focus lag op het creëren van een robuust en schaalbaar platform met Next.js, TypeScript en andere geavanceerde technologieën.

Ik droeg actief bij aan het ontwikkelingsproces door de inzet van Continuous Integration en Deployment, waarbij Jenkins werd gebruikt om codewijzigingen te automatiseren. Dit zorgde voor snelle feedback en efficiënte probleemoplossing.

Door mijn expertise in Next.js en React, gecombineerd met een gedetailleerde backlog en effectieve samenwerking binnen het team, bouwden we een platform dat niet alleen een naadloze gebruikerservaring biedt, maar ook bijdraagt aan de missie van Robidus in de sociale zekerheid.`,
    technologies: ["Next.js", "TypeScript", "React", "Jenkins", "CI/CD"],
    color: "violet",
    highlights: [
      "Sociale zekerheid data-integratieplatform",
      "CI/CD-automatisering met Jenkins",
      "Naadloze gebruikerservaring voor complexe workflows",
    ],
    achievements: [
      "Platform gebouwd dat jaarlijks 10.000+ gevallen verwerkt",
      "Verwerkingstijd van gevallen met 50% verminderd",
      "100% AVG-naleving gehandhaafd",
    ],
    responsibilities: [
      "Frontend ontwikkelen met Next.js en React",
      "CI/CD-pijplijnen implementeren met Jenkins",
      "Meerdere databronnen integreren",
      "Beveiliging en AVG-naleving garanderen",
    ],
    impact: [
      "Sociaal zekerheidsgevallenbeheer gestroomlijnd",
      "Efficiëntie voor medewerkers verbeterd",
      "Data-nauwkeurigheid en betrouwbaarheid verbeterd",
    ],
  },
  {
...
Samenwerking met productmanagers, UX-ontwerpers, backend-engineers en QA-testers zorgde voor afstemming en kwaliteit. De applicaties die ik ontwikkelde, behaalden uitstekende 4,5+ ster beoordelingen en positieve gebruikersrecensies, wat de focus op prestaties en gebruikerservaring valideerde. Deze rol versterkte mijn mobiele ontwikkelingsexpertise en cross-platform architectuurvaardigheden.`,
  ...
  },
  {
    ...
    location: "Amsterdam, Nederland",
    description:
      "Frontend-ontwikkelingsopdracht via Rebels, waarbij moderne webapplicaties werden gebouwd met React en TypeScript.",
...
De Rebels-ervaring was transformerend voor mijn carrière, waarbij ik werd blootgesteld aan enterprise-schaal systemen, diverse technische architecturen en high-performance teamomgevingen. Het bouwde vertrouwen in mijn vermogen om complexe technische uitdagingen aan te pakken, snel aan te passen aan nieuwe domeinen en consistent professionele resultaten te leveren. De nadruk van de consultancy op continu leren en technische excellentie sloot perfect aan bij mijn groeimindset, wat een sterke basis vestigde voor senior-level rollen.`,
  ...
  },
  {
    ...
    location: "Amsterdam, Nederland",
    description:
      "Frontend-ontwikkeling voor MensCentraal-applicatie met SASS en Java JSF/Primefaces-componenten.",
...
Ik werkte met SASS om componenten te stylen, vaak gebouwd met Primefaces-componenten. De applicatie was een webgebaseerde Java (JSF/Primefaces)-applicatie, wat nauwe samenwerking met backend-ontwikkelaars vereiste om naadloze integratie te garanderen.`,
  ...
  },
  {
    ...
    location: "Zaandam, Nederland",
    description:
      "Frontend-ontwikkeling voor SAP Hybris E-Commerce platform met diepe integratie in backend-systemen.",
    longDescription: `Bij Timber and Building Supplies Holland N.V. speelde ik een cruciale rol als Hybris E-Commerce Developer, waarbij mijn focus primair lag op frontend-ontwikkeling. Mijn verantwoordelijkheden omvatten het ontwerpen en implementeren van gebruikersinterfaces met behulp van geavanceerde webtechnologieën, terwijl ik ook nauw samenwerkte met het backend-team.

Tijdens mijn tijd bij het bedrijf verdiepte ik me ook in Java en SAP. Dit stelde me niet alleen in staat om aan de frontend te werken, maar ook om grondig begrip en praktische ervaring op te doen in de backend-aspecten van het Hybris E-Commerce platform. Mijn werk omvatte het integreren van SAP-systemen met het Hybris-platform, wat essentieel was voor het efficiënt beheren van online retailprocessen.

Ik droeg actief bij aan verschillende projectfasen, van concept en ontwerp tot ontwikkeling en implementatie. Mijn vaardigheden in frontend-technologieën, gecombineerd met mijn vermogen om Java- en SAP-aspecten te begrijpen en te implementeren, stelde me in staat bij te dragen aan een naadloze en geïntegreerde e-commerce-ervaring voor onze klanten.`,
    technologies: [
      "SAP Hybris",
      "Java",
      "SAP Integration",
    ...
    color: "cyan",
    highlights: [
      "SAP Hybris e-commerce platformontwikkeling",
      "Frontend en backend integratie",
      "Naadloze online retailervaring",
    ],
    achievements: [
      "50.000+ product-SKU's beheerd",
      "€5M+ aan jaarlijkse online verkopen verwerkt",
      "1.000+ B2B-klanten succesvol bediend",
    ],
    responsibilities: [
      "Frontend ontwikkelen voor Hybris-platform",
      "SAP-systemen integreren met e-commerce",
      "Complexe B2B-workflows implementeren",
      "Prestaties en gebruikerservaring optimaliseren",
    ],
    impact: [
  ...
  },
  {
    ...
    location: "Nederland",
    description:
      "Frontend-ontwikkeling met moderne JavaScript frameworks en responsive design technieken.",
...
Ik werkte samen met ontwerpers en backend-ontwikkelaars om hoogwaardige weboplossingen op te leveren, waarbij cross-browser compatibiliteit en optimale prestaties werden gegarandeerd.`,
  ...
  },
  {
    ...
    location: "Zaandam, Nederland",
    description:
      "Softwareontwikkelingsstage en junior rol bij toonaangevende content management solutions provider.",
...
Ik droeg bij aan het ontwikkelen van functies voor WoodWing's content management platform, werkte samen met senior engineers en kreeg kennis van complexe softwaresystemen.`,
  ...
  },
  {
    ...
    location: "Nederland",
    description:
      "Junior softwareontwikkelingsrol gericht op webapplicaties en softwareoplossingen.",
...
Ik werkte aan verschillende projecten, leerde best practices voor softwareontwikkeling en kreeg hands-on ervaring met webtechnologieën.`,
  ...
  },
  {
    ...
    location: "Nederland",
    description:
      "Webontwikkelingsstage gericht op PHP, MySQL en JavaScript. Google Maps-applicatie gebouwd voor Biernet.nl.",
...
Deze stage bood fundamentele ervaring in webontwikkeling, databasebeheer en werken met API's.`,
  ...
  },
  {
    ...
    location: "Nederland",
    description:
      "Applicatieontwikkelingsstage waarbij werd gewerkt aan CMS-systemen en de Feest Familie-website.",
