...
export const cvDataNL: CVData = {
  ...
  skills: [
    {
      ...
      items: [
        ...
        "Angular",
        "HTML5 (Semantische Markup, Toegankelijkheid)",
        ...
        "Web Toegankelijkheid (WCAG 2.1 AA/AAA, ARIA)",
        "SEO Optimalisatie",
        "Storybook (Component Documentatie)",
        "Framer Motion (Animatie)",
        "GSAP",
        "React Native",
        "Expo SDK",
    ...
    },
    {
      ...
      items: [
        ...
        "Microservices Architectuur (Event-Driven, CQRS)",
        "Serverless Functions",
        "PostgreSQL (Geavanceerde Queries, Indexes)",
        ...
        "Sequelize",
        "SQLAlchemy",
        "Authenticatie (JWT, OAuth 2.0, SAML)",
    ...
    },
    {
      ...
      items: [
        ...
        "Git (Geavanceerde Workflows, Rebasing)",
        "GitHub Actions",
        "GitLab CI/CD",
        "Jenkins",
        "CircleCI",
    ...
    },
    {
      ...
      items: [
        ...
        "Toegankelijkheids Testing (axe, Pa11y)",
    ...
    },
    {
      ...
      items: [
        ...
        "Magento",
        "SAP Hybris Commerce",
        "Stripe (Betalingen, Abonnementen, Webhooks)",
        "PayPal Integratie",
        "Betalingsverwerking (PCI Compliance)",
        "Multi-valuta Ondersteuning",
        "Multi-tenant Architectuur",
        "POS Systemen Integratie",
        "Voorraadbeheer",
    ...
    },
    {
      ...
      items: [
        "SQL (Complexe Queries, Optimalisatie)",
        "NoSQL (Document, Key-Value Stores)",
        "Database Design (Normalisatie, Indexing)",
        "Data Modellering",
        "Google Analytics 4",
        "Mixpanel",
        "Segment",
    ...
    },
    {
      ...
      items: [
        ...
        "GitFlow Workflow",
        "Documentatie (Technisch Schrijven, API Docs)",
    ...
    },
    {
      ...
      items: [
        "Technisch Leiderschap (Team Lead, Architect)",
        "Team Mentoring & Coaching",
        "Stakeholder Communicatie & Management",
        "Klantrelaties",
        "Probleemoplossing & Kritisch Denken",
        "Projectmanagement",
        "Code Review & Kwaliteitscontrole",
        "Kennisdeling",
        "Agile Methodologieën (Scrum Master)",
        "Cross-functionele Samenwerking",
        "Presentatievaardigheden",
        "Technisch Schrijven & Documentatie",
        "Conflictoplossing",
        "Tijdmanagement",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Intelligent applicant tracking systeem voor geautomatiseerde vacature-kandidaat matching. AI-powered cv parsing en semantische job matching gebouwd met vector embeddings. Geautomatiseerde screening workflows en kandidaat ranking geïmplementeerd op basis van functie-eisen en ervaring.",
      technologies: [
        "Next.js",
        "OpenAI GPT-4",
        "LangChain",
    ...
    },
    {
      ...
      description:
        "SaaS platform voor geautomatiseerde webtoegang elijksheidstesting en WCAG compliance. Scanning engine gebouwd met Playwright voor cross-browser testing met gedetailleerde rapportage en hersteladvies. Chrome extensie ontwikkeld voor realtime toegankelijkheidsaudit tijdens ontwikkeling.",
      technologies: [
        "Next.js",
        "Playwright",
        "PostgreSQL",
    ...
    },
    {
      ...
      description:
        "Modern commerce platform gebouwd op MedusaJS met aangepaste Next.js storefront. Multi-valuta oplossing gearchitectureerd met Stripe betalingsverwerking en Algolia product search. Admin dashboard gebouwd voor voorraad- en orderbeheer met abonnement ondersteuning.",
      technologies: [
        "MedusaJS",
        "Next.js",
        "TypeScript",
  ...
  education: [
    {
      ...
      period: "2014 - 2019",
      description:
        "Focus op software architectuur, webtechnologieën en agile ontwikkelmethodologieën",
    },
    {
      ...
      period: "2011 - 2014",
      description:
        "ICT Applicatieontwikkeling met focus op webontwikkeling en database design",
    },
  ],
